...
class ICFGPEDES(BaseDataset):
    ...
    def __init__(self, root='', verbose=True):
        ...
        self.anno_path = op.join(self.dataset_dir, 'ICFG-PEDES_mcq_noun_neg.json')
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            for anno in annos:
                ...
                caps_noun_phrase = anno["cap_noun_phrases"]
                for i in range(len(captions)):
                    caption = captions[i]
                    cap_noun_phrase = caps_noun_phrase[i]
                    dataset.append((pid, image_id, img_path, caption, cap_noun_phrase))  # 返回对应noun
