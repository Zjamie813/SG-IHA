...
def build_optimizer(args, model):
    ...
    for key, value in model.named_parameters(): # base_model.positional_embedding
        ...
        if "bridge_encoder" in key or "bridge_proj" in key:
            lr = args.lr * args.mcq_lr_factor
        if "gate_linear_proj" in key:
            lr = args.lr * args.mcq_lr_factor
